...
export default class Front2 extends Component {
  render() {
    return (
      <ImageBackground style={{height:this.props.height,alignItems:'center',width:this.props.width,alignItems:'center',marginTop:-12}} source={require('../Images/splash(2).png')}>
        ...
        <Image style={{marginTop:50}} source={require('../Images/Group(2).png')} />
        </View>
